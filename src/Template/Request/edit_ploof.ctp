...
<button type="button" class="btn btn-primary" onclick="location.href='/silver/request/edit/'">修正</button>
<button type="submit" class="btn btn-success" name="edit_ok" onclick="">確定</button>
