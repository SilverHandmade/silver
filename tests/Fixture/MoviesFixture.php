...
class MoviesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'contribution' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '投稿日', 'precision' => null],
        'movie_url' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '動画URL', 'precision' => null],
        'facility_id' => ['type' => 'integer', 'length' => 6, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '投稿者ID', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'contribution' => '2017-11-06 06:16:43',
