...
class WitsesFixture extends TestFixture
{
    ...
    public $fields = [
        'id' => ['type' => 'integer', 'length' => 9, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '知恵ID', 'precision' => null, 'autoIncrement' => null],
        ...
        'user_id' => ['type' => 'integer', 'length' => 10, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '投稿者', 'precision' => null, 'autoIncrement' => null],
