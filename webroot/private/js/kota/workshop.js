$(function(){
	...
	var imagename = 1;
	$('#add').click(function() {
		var plusHtml = '<div class="row none div-margin-top" id="plusHtml"><div class="col-md-1"><button class="btn btn-default" type="button" name="button" id="remove"><span class="glyphicon glyphicon-remove-sign"></span></button></div><div class="col-md-3"><div class="div-btn padding"><input type="file" class="input-file none file" name="upload_gazo' + imagename++ +'" accept="image/*"><button type="button" name="" id="upload" class="button">画像選択</button></div><span id="fake_input_file" class="span">NOT FILE</span></div><div class="col-md-8"><input class="form-control" type="text" name="text' + name++ +'"></div></div>';
